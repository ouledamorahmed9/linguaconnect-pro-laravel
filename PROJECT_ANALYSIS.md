...
## Snapshot
- **Stack**: Laravel 9 (PHP ≥ 8.0.2), Sanctum (API tokens), Breeze (auth scaffolding), Vite ^4 + Tailwind ^3.1.0 + Alpine ^3.4.2 + Axios ^1.1.2 (frontend), Spatie Activity Log, Doctrine DBAL.  
