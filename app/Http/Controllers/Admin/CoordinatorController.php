...
class CoordinatorController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        User::create([
            ...
            'role' => 'coordinator', // أهم خطوة: تحديد الدور كـ 'coordinator'
            'email_verified_at' => now(), // نجعل إيميله موثقاً تلقائياً
        ]);

        return redirect()->route('admin.coordinators.index')->with('status', 'تم إنشاء حساب المنسق بنجاح!');
    }
