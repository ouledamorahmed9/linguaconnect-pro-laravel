                        ...
                        @if($subscription)
                            <div>
                                ...
                                <div class="w-full bg-gray-200 rounded-full h-4">
                                    @php
                                        // THIS IS THE FIX:
                                        // We check if total_lessons is greater than 0 before dividing.
                                ...
                                <div class="mt-6 border-t pt-6">
                                    <button class="w-full px-4 py-2 bg-red-100 text-red-700 font-semibold rounded-lg hover:bg-red-200">إلغاء الاشتراك الحالي</button>
                                </div>
                            </div>
                        @else
