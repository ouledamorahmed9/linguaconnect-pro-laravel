    ...
    <div class="py-12" x-data="{ search: '' }">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <form method="POST" action="{{ route('admin.roster.update', $weeklySlot) }}">
                    @csrf
                    @method('PATCH')
                    ...
                    <div class="p-6 md:p-8 space-y-6 text-gray-900">
                        ...
                        <div class="flex items-center justify-end pt-4 gap-3">
                            <a href="{{ route('admin.roster.index', ['teacher_id' => $weeklySlot->teacher_id]) }}" class="px-4 py-2 text-gray-600 hover:text-gray-800 text-sm font-semibold">
                                إلغاء
                            </a>
                            <x-primary-button>
                                {{ __('حفظ التغييرات') }}
