<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('coordinator.clients.create') }}" class="px-4 py-2 bg-indigo-600 text-white text-sm font-semibold rounded-lg shadow-md hover:bg-indigo-700">
                إضافة عميل جديد
            </a>
        </div>
    </x-slot>
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full bg-white">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse ($clients as $client)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-left text-sm font-medium space-x-4">
                                            <a href="{{ route('coordinator.clients.edit', $client) }}" class="text-indigo-600 hover:text-indigo-900">تعديل</a>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="px-6 py-12 text-center text-gray-500">لم تقم بإضافة أي عملاء حتى الآن.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
            ...
            <div @click.away="openModal = false" class="bg-white rounded-lg shadow-xl p-6 w-full max-w-md mx-4">
                <div class="text-center">
                    ...
                    <div class="mt-6 flex justify-center gap-4">
                        <form :action="'{{ url('coordinator/clients') }}/' + clientId" method="POST">
                            @csrf
                            @method('DELETE')
