<x-guest-layout>
    <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-indigo-50/50 relative overflow-hidden py-12 px-4 sm:px-6 lg:px-8" dir="rtl">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <select id="study_subject_id" name="study_subject_id" required
                                ...
                                {{-- Loop through subjects if variable exists --}}
