        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="p-4 mb-6 bg-indigo-50 border-l-4 border-indigo-400 rounded-r-lg">
                <p class="text-sm text-indigo-700">
                    ...
                    هنا يمكنك مراجعة جميع الحصص التي تم تسجيلها من قبل معلمك وملاحظاته عليها.
                </p>
            </div>
                ...
                <div class="p-6 md:p-8 text-gray-900">
                    ...
                    @if($lessons->isEmpty())
                        <div class="flex flex-col items-center justify-center h-64 border-2 border-dashed border-gray-300 rounded-lg text-center p-8">
                            ...
                            <p class="mt-2 text-sm text-gray-500">لم يقم معلمك بتسجيل أي حصص مكتملة حتى الآن.</p>
                        </div>
                    @else
                        <div class="space-y-6">
                                ...
                                <div class="bg-white overflow-hidden shadow-sm rounded-lg border border-gray-200">
                                    ...
                                    <div class="p-4 sm:p-5">
                                        ...
                                        <p class="text-sm text-gray-600 mt-1">
                                            المعلم: <span class="font-medium">{{ $lesson->teacher->name }}</span>
                                        </p>
                                        
                                        @if($lesson->teacher_notes)
                                            <div class="mt-4 border-t pt-4">
                                                <h5 class="text-sm font-semibold text-gray-700">ملاحظات المعلم:</h5>
