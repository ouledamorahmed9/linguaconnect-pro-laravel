                    ...
                    <form method="POST" action="{{ route('admin.study-subjects.update', $studySubject) }}">
                        ...
                        <div class="mb-6">
                            ...
                            <x-text-input 
                                ...
                                type="text" 
                                name="name" 
                                :value="old('name', $studySubject->name)" 
                                required 
                                autofocus
                        ...
                        <div class="mb-6">
                            ...
                            <x-text-input 
                                ...
                                type="text" 
                                name="name_ar" 
                                :value="old('name_ar', $studySubject->name_ar)"
                                dir="rtl"
                        ...
                        <div class="mb-6">
                            ...
                            <div class="mt-1 flex items-center space-x-4">
                                <input 
                                    ...
                                    id="color" 
                                    name="color" 
                                    value="{{ old('color', $studySubject->color) }}"
                        ...
                        <div class="mb-6">
                            ...
                            <x-text-input 
                                ...
                                type="number" 
                                name="sort_order" 
                                :value="old('sort_order', $studySubject->sort_order)"
                                min="0" />
                        ...
                        <div class="mb-6">
                            <label class="flex items-center">
                                <input 
                                    ...
                                    name="is_active" 
                                    value="1"
                                    {{ old('is_active', $studySubject->is_active) ? 'checked' : '' }}
                        ...
                        <div class="mb-6 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                            ...
                            <div class="flex items-center p-3 bg-white dark:bg-gray-800 rounded-md border border-gray-200 dark:border-gray-600">
                                ...
                                <span id="preview_name_ar" class="text-gray-500 dark: text-gray-400 mr-2" dir="rtl">{{ $studySubject->name_ar ?  '(' . $studySubject->name_ar . ')' : '' }}</span>
                            </div>
                        </div>
                        ...
                        <div class="mb-6 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark: border-blue-800">
                            <div class="flex items-center">
                                ...
                                <span class="text-sm text-blue-700 dark:text-blue-300">
                                    {{ __('This subject is currently assigned to : count student(s)', ['count' => $studySubject->users()->count()]) }}
                                </span>
                            </div>
                        </div>
