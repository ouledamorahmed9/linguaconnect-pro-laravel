                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('admin.study-subjects.store') }}">
                        ...
                        <div class="mb-6">
                            ...
                            <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" : value="old('name')" required autofocus placeholder="e.g., English, French, Quran" />
                            <x-input-error :messages="$errors->get('name')" class="mt-2" />
                        </div>

                        <div class="mb-6">
                            <x-input-label for="name_ar" : value="__('Subject Name (Arabic)')" />
                            <x-text-input id="name_ar" class="block mt-1 w-full" type="text" name="name_ar" : value="old('name_ar')" dir="rtl" placeholder="مثال: الإنجليزية، الفرنسية، القرآن" />
                        ...
                        <div class="mb-6">
                            ...
                            <div class="mt-1 flex items-center space-x-4">
                                ...
                                <x-text-input id="color_text" class="w-32" type="text" value="{{ old('color', '#4F46E5') }}" placeholder="#4F46E5" maxlength="7" />
                            </div>
                        ...
                        <div class="mb-6">
                            ...
                            <x-text-input id="sort_order" class="block mt-1 w-32" type="number" name="sort_order" :value="old('sort_order', 0)" min="0" />
