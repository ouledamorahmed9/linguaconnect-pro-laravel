<x-app-layout>
    ...
    const calendarEvents = @json($calendarEvents);
                    ...
                    <div x-show="viewMode === 'calendar'" x-init="
        if (viewMode === 'calendar') {
            initFullCalendar(calendarEvents);
        }
        $watch('viewMode', (value) => {
            if (value === 'calendar') {
                setTimeout(() => initFullCalendar(calendarEvents), 0);
            }
        });
     " 
     class="p-6 md:p-8">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            window.initFullCalendar = (calendarEventsJson) => {
                ...
                if (calendarWrapper.dataset.calendarInitialized) {
                ...
                calendar.render();
                calendarWrapper.style.display = 'block';
                calendarWrapper.dataset.calendarInitialized = 'true'; // Set flag
            }
        });
    </script>
