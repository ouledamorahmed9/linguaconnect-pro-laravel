            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                                                    ...
                                                    @foreach($slots as $slot)
                                                        <tr>
                                                            ...
                                                            <td class="px-4 py-3 whitespace-nowrap text-sm flex gap-2">
                                                                <a href="{{ route('admin.roster.edit', $slot) }}" class="px-3 py-2 bg-white text-indigo-700 border border-indigo-300 font-semibold rounded-lg text-xs hover:bg-indigo-50">
                                                                    تعديل الحصة
                                                                </a>
                ...
                @else
                    <div class="p-6 md:p-8">
                        <div class="flex flex-col items-center justify-center h-96 border-2 border-dashed border-gray-300 rounded-lg textcenter p-8">
