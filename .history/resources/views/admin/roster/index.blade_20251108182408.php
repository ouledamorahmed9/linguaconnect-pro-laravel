                ...
                @if($selectedTeacher)
                    ...
                    <div x-show="viewMode === 'list'" class="grid grid-cols-1 lg:grid-cols-3 gap-8 p-6 md:p-8">
                        ...
                        <div class="lg:col-span-1">
                            ...
                            @endif
                            @if ($errors->any())
                                <div class="mb-4 p-4 text-sm text-red-700 bg-red-100 rounded-lg" role="alert"><strong>خطأ!</strong> {{ $errors->first('message') ?? $errors->first('client_id') ?? 'الرجاء مراجعة بيانات الإدخال.' }}</div>
                            @endif
                            ...
                            @else
                                <div class="space-y-6">
                                    ...
                                    @foreach($weeklySlots as $clientName => $slots)
                                        ...
                                        @php
                                            // We get the first slot to check the subscription.
                                            // This is safe because slots are grouped by client.
                ...
                @else
                    ...
                    <div class="p-6 md:p-8">
                        <div class="flex flex-col items-center justify-center h-96 border-2 border-dashed border-gray-300 rounded-lg text-center p-8">
                            <svg class="h-16 w-16 text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
