<x-app-layout>
    ...
    We set 'list' as the default view.
    ==================================================================
    -->
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                @if($selectedTeacher)
                    ...
                    <!-- === ** STEP 2: VIEW TOGGLE BUTTONS (RTL icon fix) ** === -->
...
<!-- === ** STEP 4: "CALENDAR VIEW" WRAPPER (FIXED) ** === -->
<div 
    ...
    x-init="
        ...
        $watch('viewMode', (value) => {
            if (value === 'calendar') {
                // Delay to ensure element is visible before initializing
                setTimeout(() => initFullCalendar(@json($calendarEvents)), 0);
            }
        });
    "
    class="p-6 md:p-8"
    style="display: none;"  <!-- Keep this outside attributes -->
>
