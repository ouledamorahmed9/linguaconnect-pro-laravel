                                ...
                                <div class="shadow overflow-hidden border-b border-gray-200 dark:border-gray-700 sm:rounded-lg">
                                    ...
                                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                        ...
                                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                            ...
                                            <!-- !! THE FIX: Using your variable $pendingSessions as $session !! -->
                                            ...
                                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-600">
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-300">
                                                    {{ \Carbon\Carbon::parse($session->start_time)->format('D, M j, Y \a\t g:i A') }}
                                                </td>
                                                
                                                <!-- PROFESSIONAL STATUS BADGES (Based on your old file logic) -->
                                                <td class="px-6 py-4 whitespace-nowrap text-sm">
                                                    @if($session->meetReport && $session->status === 'verified') <!-- CHANGED: was 'completed' -->
                                                ...
                                                <!-- MEET REPORT BUTTON / MODAL (Based on your old file logic) -->
                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-300">
                                                                    ...
                                                                    <div class="inline-block align-bottom bg-white dark:bg-gray-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                                                                        <div class="bg-white dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                                                            <h3 class="text-lg leading-6 font-medium text-gray-900 dark:text-white mb-3">
                                                                                Meet Report: {{ $session->meetReport->meeting_code }}
                                                                            </h3>
                                                                            <div class="text-sm text-gray-600 dark:text-gray-300">
                                                                                <p><strong>Date:</strong> {{ $session->meetReport->report_data['date'] ?? 'N/A' }}</p>
                                                                                ...
                                                                                <ul class="list-disc list-inside mt-2 max-h-60 overflow-y-auto">
                                                                                    @if(isset($session->meetReport->report_data['participants']) && is_array($session->meetReport->report_data['participants']))
                                                    ...
                                                    @elseif($session->session_proof) <!-- Your old proof column -->
                                                ...
                                                <!-- ACTION BUTTONS (Based on your old file logic) -->
                                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                    @if(!in_array($session->status, ['verified', 'rejected', 'completed']))
                                                        <!-- Verify Button -->
                                                        <form method="POST" action="{{ route('admin.sessions.verify', $session) }}" class="inline">
                                                            @csrf
                                                            @method('PATCH')
                                                        ...
                                                        <form method="POST" action="{{ route('admin.sessions.dispute', $session) }}" class="inline ml-4">
                                                            @csrf
                                                    ...
                                                    @else
                                                        <!-- If status is 'verified', show no actions -->
