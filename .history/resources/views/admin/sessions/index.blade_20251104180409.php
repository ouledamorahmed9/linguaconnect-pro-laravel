                                    ...
                                    @foreach($sessions as $session)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2 rtl:space-x-reverse">
                                                ...
                                                <!-- Dispute Button (You can implement this page later) -->
                                                <!--
                                                <form method="POST" action="{{ route('admin.sessions.dispute', $session) }}" class="inline-block">
                                                    @csrf
                                                    <button type="submit" class="text-red-600 hover:text-red-900">نزاع</button>
                                                </form>
                                                -->
                                            </td>
                                        </tr>
