                                        ...
                                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                            ...
                                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-600">
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                    @if($appointment->status == 'pending_verification' || $appointment->status == 'conflict' || $appointment->status == 'cancelled')
                                                        <!-- Verify Button -->
                                                        ...
                                                        <form method="POST" action="{{ route('admin.sessions.dispute', $appointment) }}" class="inline ml-4">
                                                            @csrf
                                                            <!-- You might need to add a reason field here later -->
                                            ...
                                            @endforelse <!-- <-- THIS IS THE FIX. It was @forelse before. -->
