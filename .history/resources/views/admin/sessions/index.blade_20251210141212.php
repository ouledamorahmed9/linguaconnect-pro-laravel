<x-app-layout>
    ...
    <div class="py-12" x-data="{ reportModalOpen: false, sessionData: null }">
        ...
        {{-- MODAL TEMPLATE (No changes needed here, just context) --}}
        <template x-if="reportModalOpen">
            <div class="fixed inset-0 bg-gray-800 bg-opacity-50 flex items-center justify-center z-50" x-transition>
                <div class="bg-white rounded-xl shadow-2xl p-6 w-full max-w-lg relative" x-transition.scale>
                    ...
                    {{-- Handle Errors in Decryption --}}
                    <div x-show="sessionData && sessionData.error" class="bg-red-50 text-red-700 p-4 rounded mb-4">
                        <p><strong>خطأ في فك التشفير:</strong></p>
                        <p x-text="sessionData.error"></p>
                    </div>

                    <div x-show="sessionData && !sessionData.error" class="space-y-2 text-sm">
                        <p><strong>📅 التاريخ:</strong> <span x-text="sessionData.date || 'N/A'"></span></p>
                        <p><strong>🕒 المدة:</strong> <span x-text="sessionData.duration || 'N/A'"></span></p>
                        <p><strong>👥 عدد المشاركين:</strong> <span x-text="sessionData.participantsCount || 'N/A'"></span></p>
                        <p><strong>⏱ متوسط الوقت في المكالمة:</strong> <span x-text="sessionData.avgTimeInCall || 'N/A'"></span></p>
                        <p><strong>🕰 وقت البدء:</strong> <span x-text="sessionData.startTime || 'N/A'"></span></p>
                        <p><strong>🏁 وقت الانتهاء:</strong> <span x-text="sessionData.endTime || 'N/A'"></span></p>
                    </div>
                        ...
                        <table class="w-full border text-sm">
                            <thead class="bg-blue-100">
                                <tr>
                                    ...
                                    <th class="border px-2 py-1">المدة</th>
                                </tr>
                            </thead>
                            <tbody>
