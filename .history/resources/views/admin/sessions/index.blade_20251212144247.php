                                    ...
                                    @foreach($sessions as $session)
                                        ...
                                        <tr @if($session->client->coordinator) class="bg-red-50" @endif>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                ...
                                                {{-- ** UPDATED: Use server-side decrypted data ** --}}
    ...
    <template x-if="reportModalOpen">
        ...
        >
            ...
            >
                ...
                {{-- Display Error if Decryption Failed --}}
                <div x-show="sessionData && sessionData.error" class="mb-4 p-3 bg-red-100 text-red-700 rounded text-sm">
                    <strong>Error:</strong> <span x-text="sessionData.error"></span>
                </div>

                {{-- Display Data if Success --}}
