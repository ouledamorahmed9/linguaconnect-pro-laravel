<x-app-layout>
    ...
    <div class="py-12" x-data="{ reportModalOpen: false, sessionData: null }">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                <div class="flex items-center justify-end space-x-2 rtl:space-x-reverse">
                                                    ...
                                                    @if($session->extension_data)
                                                        <button 
                                                            type="button"
                                                            class="text-xs bg-gray-100 hover:bg-gray-200 text-gray-800 py-1 px-2 rounded"
                                                            x-on:click="
        ...
        <template x-if="reportModalOpen">
            <div class="fixed inset-0 bg-gray-900 bg-opacity-75 flex items-center justify-center z-50" x-transition>
                <div class="bg-white rounded-lg shadow-xl p-6 w-full max-w-lg" @click.away="reportModalOpen = false">
                    
                    <div class="flex justify-between items-center mb-4 border-b pb-2">
                        <h3 class="text-lg font-bold text-gray-800">تفاصيل الجلسة (من الامتداد)</h3>
                    ...
                    <div x-show="sessionData && sessionData.error" class="bg-red-50 text-red-700 p-3 rounded mb-4 text-sm">
                        <strong>خطأ:</strong> <span x-text="sessionData.error"></span>
                    </div>
