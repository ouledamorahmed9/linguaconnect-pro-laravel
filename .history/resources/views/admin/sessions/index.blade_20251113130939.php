                                                ...
                                                <div class="flex items-center justify-end space-x-2 rtl:space-x-reverse">
                                                    ...
                                                    @if($session->extension_data)
                                                        <x-secondary-button
                                                            type="button"
                                                            class="text-xs"
                                                            data-json="@json(json_decode($session->extension_data))"
                                                            x-on:click="
                                                                sessionData = JSON.parse($event.currentTarget.dataset.json);
        ...
        <x-modal name="report-modal" x-show="reportModalOpen" @close="reportModalOpen = false" max-width="2xl">
            <div class="p-6" x-if="sessionData">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                    ...
                    <div class="space-y-4">
                        <h3 class="text-lg font-semibold text-gray-800 border-b pb-.5">
                            الحضور
                ...
                <div class.5="mt-6 pt-4 border-t">
