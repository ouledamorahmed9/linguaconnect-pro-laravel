                                ...
                                @if(isset($weeklySlots[$dayNumber]) && $weeklySlots[$dayNumber]->count() > 0)
                                    <div class="space-y-4">
                                        ...
                                        @foreach($weeklySlots[$dayNumber] as $slot)
                                            ...
                                            <div class="bg-white overflow-hidden shadow-sm rounded-lg @if($slot->hasActiveSubscription) border-gray-200 @else border-red-400 border-2 @endif">
                                                <div class="p-5">
