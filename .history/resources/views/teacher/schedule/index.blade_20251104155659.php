                                ...
                                @foreach($weeklySlots[$dayNumber] as $slot)
                                    <div class="bg-white overflow-hidden shadow-sm rounded-lg border border-gray-200">
                                        ...
                                        <div class="bg-gray-50 px-5 py-3 border-t">
                                            <!-- 
                                                This button is the NEXT STEP.
                                                It will link to the "Log Session" page for this slot.
                                            -->
                                            <button disabled class="w-full text-center px-4 py-2 bg-gray-300 text-white font-semibold rounded-lg text-sm opacity-50 cursor-not-allowed">
                                                تسجيل الحصة (قريبًا)
                                            </button>
                                        </div>
                                    </div>
