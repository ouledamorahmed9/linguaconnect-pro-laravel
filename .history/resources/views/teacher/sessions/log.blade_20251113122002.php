                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <select id="completion_status" name="completion_status" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>
                                    ...
                                    <option value="student_absent" @if(old('completion_status') == 'student_absent') selected @endif>الطالب لم يحضر</option>
                                    <option value="technical_issue" @if(old('completion_status') == 'technical_issue') selected @endif>مشكلة تقنية</option>
                                </select>
                            ...
                            <div>
                                <x-input-label for="extension_data" :value="__('بيانات الإضافة (JSON) (اختياري)')" />
                                <textarea id="extension_data" name="extension_data" rows="5" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm font-mono text-sm" placeholder="الصق كود JSON هنا...">{{ old('extension_data') }}</textarea>
                            ...
                            <div>
                                ...
                                <x-text-input id="session_proof" class="block mt-1 w-full" type="url" name="session_proof" :value="old('session_proof')" placeholder="[https://drive.google.com/](https://drive.google.com/)..." />
