    ...
    <section class="py-20 bg-gray-50">
        <div class="container mx-auto px-6">
            <div class="text-center mb-16">
                <h2 class="text-3xl md:text-4xl font-bold text-gray-800">باقات تناسب الجميع</h2>
                <p class="text-gray-600 mt-4 max-w-2xl mx-auto">
                    أسعار مدروسة لتناسب ميزانيتك، مع خيارات مرنة من المجموعات إلى الدروس الخاصة.
                </p>
            </div>
            
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                
                <div class="bg-white rounded-2xl shadow-sm hover:shadow-lg transition-all border border-gray-200 p-6 flex flex-col">
                    <h3 class="text-lg font-bold text-gray-900">Normal Class</h3>
                    <p class="text-sm text-blue-600 font-medium mb-4">مجموعة قياسية</p>
                    <span class="text-xs bg-blue-50 text-blue-700 px-2 py-1 rounded w-fit mb-4">👥 8 طلاب كحد أقصى</span>
                    
                    <div class="mb-6 text-center">
                        <span class="text-3xl font-extrabold text-gray-900">4.37$</span>
                        <span class="text-gray-500">/ للحصة</span>
                        <p class="text-xs text-gray-400 mt-1">35$ شهرياً</p>
                    </div>

                    <a href="{{ route('pricing.index') }}" class="mt-auto block w-full py-2 px-4 border border-blue-600 text-blue-600 rounded-lg text-center font-bold hover:bg-blue-50 transition">
                        التفاصيل
                    </a>
                </div>
                ...
                <div class="bg-white rounded-2xl shadow-sm hover:shadow-lg transition-all border border-gray-200 p-6 flex flex-col">
                    ...
                    <p class="text-sm text-purple-600 font-medium mb-4">مجموعة صغيرة</p>
                    <span class="text-xs bg-purple-50 text-purple-700 px-2 py-1 rounded w-fit mb-4">👥 4 طلاب كحد أقصى</span>
                    
                    <div class="mb-6 text-center">
                        <span class="text-3xl font-extrabold text-gray-900">8.75$</span>
                        <span class="text-gray-500">/ للحصة</span>
                        <p class="text-xs text-gray-400 mt-1">70$ شهرياً</p>
                    </div>

                    <a href="{{ route('pricing.index') }}" class="mt-auto block w-full py-2 px-4 border border-purple-600 text-purple-600 rounded-lg text-center font-bold hover:bg-purple-50 transition">
                        التفاصيل
                    </a>
                </div>
                ...
                <div class="bg-white rounded-2xl shadow-sm hover:shadow-lg transition-all border border-gray-200 p-6 flex flex-col">
                    ...
                    <p class="text-sm text-teal-600 font-medium mb-4">أنت وصديقك</p>
                    <span class="text-xs bg-teal-50 text-teal-700 px-2 py-1 rounded w-fit mb-4">👥 طالبين فقط</span>
                    
                    <div class="mb-6 text-center">
                        <span class="text-3xl font-extrabold text-gray-900">13.75$</span>
                        <span class="text-gray-500">/ للحصة</span>
                        <p class="text-xs text-gray-400 mt-1">110$ شهرياً</p>
                    </div>

                    <a href="{{ route('pricing.index') }}" class="mt-auto block w-full py-2 px-4 border border-teal-600 text-teal-600 rounded-lg text-center font-bold hover:bg-teal-50 transition">
                        التفاصيل
                    </a>
                </div>

                <div class="bg-white rounded-2xl shadow-xl border-2 border-indigo-600 transform scale-105 z-10 p-6 flex flex-col relative">
                    ...
                    <p class="text-sm text-indigo-600 font-medium mb-4">خصوصي 100%</p>
                    <span class="text-xs bg-indigo-50 text-indigo-700 px-2 py-1 rounded w-fit mb-4">👤 طالب واحد</span>
                    
                    <div class="mb-6 text-center">
                        <span class="text-3xl font-extrabold text-gray-900">22.50$</span>
                        <span class="text-gray-500">/ للحصة</span>
                        <p class="text-xs text-gray-400 mt-1">180$ شهرياً</p>
                    </div>

                    <a href="{{ route('pricing.index') }}" class="mt-auto block w-full py-2 px-4 bg-indigo-600 text-white rounded-lg text-center font-bold hover:bg-indigo-700 transition">
                        اشترك الآن
                    </a>
                </div>
            ...
            <div class="text-center mt-10">
                <a href="{{ route('pricing.index') }}" class="text-indigo-600 font-semibold hover:text-indigo-800 flex items-center justify-center gap-2">
