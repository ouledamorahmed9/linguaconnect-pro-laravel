            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if(Auth::user()->hasRole('admin'))
                        ...
                        <x-nav-link :href="route('admin.activity-log.index')" :active="request()->routeIs('admin.activity-log.index')">
                            سجل الأنشطة
                        </x-nav-link>
                        <x-nav-link :href="route('admin.study-subjects.index')" :active="request()->routeIs('admin.study-subjects.*')">
                    ...
                    @elseif(Auth::user()->hasRole('coordinator'))
                            ...
                            <x-nav-link :href="route('coordinator.disputes.index')" :active="request()->routeIs('coordinator.disputes.index')">
                                إدارة النزاعات
                            </x-nav-link>

                            <x-nav-link :href="route('coordinator.inbox.index')" :active="request()->routeIs('coordinator.inbox.*')">
                           صندوق الوارد
