        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 md:p-8 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('coordinator.clients.subscriptions.store', $client) }}" class="space-y-6">
                        @csrf
                        ...
                        <div class="flex items-center justify-end mt-6">
                            <a href="{{ route('coordinator.clients.edit', $client) }}" class="text-sm text-gray-600 hover:text-gray-900 mr-4">
                                إلغاء
                            </a>
