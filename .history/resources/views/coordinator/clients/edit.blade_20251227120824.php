                    ...
                    <div class="p-6 md:p-8 text-gray-900">
                        ...
                        @if($subscription)
                            ...
                            <x-modal name="confirm-subscription-deletion" focusable>
                                <form method="POST" action="{{ route('coordinator.subscriptions.destroy', $subscription) }}" class="p-6">
                                    @csrf
                                    @method('DELETE')
                        ...
                        @else
                            <div class="text-center">
                                ...
                                <a href="{{ route('coordinator.clients.subscriptions.create', $client) }}" class="mt-4 block w-full text-center px-4 py-2 bg-indigo-600 text-white font-semibold rounded-lg hover:bg-indigo-700">
                                    تعيين باقة جديدة
                                </a>
                            </div>
                        @endif
