                                    ...
                                    @foreach($disputes as $dispute)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2 rtl:space-x-reverse">
                                                ...
                                                <form method="POST" action="{{ route('coordinator.disputes.cancel', $dispute) }}" class="inline-block" onsubmit="return confirm('هل أنت متأكد من حل هذا النزاع وتأكيد رفض الحصة؟ لن يتم احتساب الحصة.');">
                                                    @csrf
                                                    @method('PATCH')
