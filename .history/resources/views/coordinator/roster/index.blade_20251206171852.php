                ...
                @if($selectedTeacher)
                    ...
                    <div x-show="viewMode === 'list'" class="p-6 md:p-8">
                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            ...
                            <!-- Slots Grid (teacher-style cards) -->
                                ...
                                @else
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        @foreach($daysOfWeek as $dayNumber => $dayName)
                                            @php $slotsForDay = $weeklySlots[$dayNumber] ?? collect(); @endphp
                                                    ...
                                                    @foreach($slotsForDay as $slot)
                                                        <div class="bg-white overflow-hidden shadow-sm rounded-lg border border-gray-200">
                                                            ...
                                                            <div class="bg-gray-50 px-5 py-3 border-t flex flex-wrap gap-2">
                                                                <a href="{{ route('coordinator.roster.edit', $slot) }}" class="px-4 py-2 bg-white text-indigo-700 border border-indigo-300 font-semibold rounded-lg text-sm hover:bg-indigo-50">
                                                                    تعديل الحصة
                                                                </a>
                                                                @php
