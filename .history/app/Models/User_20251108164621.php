...
use Laravel\Sanctum\HasApiTokens; // Your file list had this, so we'll keep it
use Illuminate\Database\Eloquent\Relations\HasMany;
use Illuminate\Database\Eloquent\Relations\BelongsToMany;
use App\Models\Subscription; // Make sure this is imported
use App\Models\Appointment;
use App\Models\WeeklySlot; // Make sure this is imported
...
class User extends Authenticatable implements MustVerifyEmail
{
    ...
    protected $fillable = [
        ...
        'password',
        'role',
        'subject', // This is from our previous feature
    ];
