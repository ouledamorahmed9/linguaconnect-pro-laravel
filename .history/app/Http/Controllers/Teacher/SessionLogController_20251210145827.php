...
class SessionLogController extends Controller
{
    ...
    public function store(Request $request, WeeklySlot $weeklySlot)
    {
        ...
        $validated = $request->validate([
            ...
            'extension_data' => 'nullable|string', // Raw string
            ...
            DB::transaction(function () use ($students, $validated, $weeklySlot, $startTime, $endTime) {
                foreach ($students as $student) {
                    ...
                    Appointment::create([
                        ...
                        'extension_data' => $validated['extension_data'] ?? null, // Store raw
        ...
        return redirect()->route('teacher.schedule.index')->with('status', 'تم تسجيل الحصة بنجاح.');
    }
}