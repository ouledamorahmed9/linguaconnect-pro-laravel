...
class MeetReportController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($teacherAttended) {
            ...
            // Teacher was NOT found. Per your request, mark as 'cancelled'.
            ...
            // --- !! LOGIC UPDATE !! ---
            Log::warning('Appointment ' . $appointment->id . ' synced but teacher name not found. Marked as cancelled.'); // Updated log

            return response()->json([
                'success' => true,
                'message' => 'Sync successful! Session marked as CANCELLED (Teacher not found in log).' // Updated message
            ]);
            // --- !! END OF UPDATE !! ---
        }
    }
