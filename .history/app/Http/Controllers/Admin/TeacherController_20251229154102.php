...
class TeacherController extends Controller
{
    ...
    public function toggleClient(Request $request, User $teacher)
{
    $request->validate([
    ...
    if ($request->checked) {
        // Link the client to the teacher
        $teacher->clients()->syncWithoutDetaching([$request->client_id]);
        return response()->json(['status' => 'attached']);
    } else {
        // Unlink the client from the teacher
        $teacher->clients()->detach($request->client_id);
